...
public class RedisUtil {
    ...
    /**
     * @author : LiuMing
     * @date : 2019/8/21 11:49
     * @description :   管道批量操作
     */
    public <T> List<T> executePipelined(RedisCallback<T> session) {
        List<T> list = (List<T>) redisTemplate.executePipelined(session);
        return list;
    }
}